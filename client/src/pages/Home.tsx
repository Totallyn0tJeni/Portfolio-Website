          ...
          >
            ...
            <div className="flex items-center gap-6 pt-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://linkedin.com/in/jenisha-patel18" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="LinkedIn">
                  <Linkedin size={20} />
                </a>
                <a href="https://instagram.com/jenisha_ptl08" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="Instagram">
                  <Instagram size={20} />
                </a>
                <a href="https://discordapp.com/users/834882747161870427" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="Discord">
