      ...
      <div className="lg:w-1/2 text-left space-y-6">
        <div className="glass-panel p-8 md:p-10 rounded-3xl backdrop-blur-xl bg-white/5 border border-white/10 shadow-2xl relative overflow-hidden group">
          ...
          <p className="text-lg md:text-xl text-white/80 leading-relaxed font-light">
            ...
            <br /><br />
            Outside of school, I volunteer as a coding and robotics mentor and support literacy and STEAM education in my community. I’ve earned certifications in Python, JavaScript, HTML, and UX Design, and I’m always excited to learn, build, and collaborate on meaningful projects.
          </p>
