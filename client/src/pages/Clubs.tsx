        ...
        <div className="grid grid-cols-1 gap-8">
          {mainClubs.map((club, idx) => (
            <motion.div
              ...
              className="glass-panel p-6 md:p-8 rounded-3xl flex flex-col md:flex-row gap-8 items-start"
            >
              {/* Image Placeholder Gallery */}
              <div className="w-full md:w-1/3 aspect-video bg-white/5 rounded-2xl overflow-hidden border border-white/10 flex items-center justify-center relative group">
                {/* Descriptive HTML comment for unsplash placeholder */}
                {/* business team meeting diverse group */}
                <img 
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <span className="text-white font-medium border border-white/30 px-4 py-2 rounded-full glass-panel">View Gallery</span>
                </div>
              </div>
                ...
                {club.link && (
                  <div className="pt-2">
                    <a 
                      ...
                      className="inline-flex items-center gap-2 text-pink-400 hover:text-pink-300 font-medium transition-colors hover:underline"
                    >
